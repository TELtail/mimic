...
def get_parser():
    ...
    parser.add_argument("-d","--data_pickle_path",help="信号のバイナリデータのパス,もしくはwfdb形式データのpath一覧csvファイル")
    ...
    parser.add_argument("--splited_one_signal_length",help="分割処理をする際にどれくらいの長さにするか",type=int,default=None)
